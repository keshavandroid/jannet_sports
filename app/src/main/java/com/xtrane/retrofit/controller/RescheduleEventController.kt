...
class RescheduleEventController(var context: Activity, internal var view: IRescheduleEventView) :
    IRescheduleController {
    override fun CallRescheduleEvent(
        id: String,
        token: String,
        eventID: String,
        date: String,
        ...
        val call: Call<ResponseBody?>? =
            apiInterface.addRescheduleEvent(id, token, eventID, date, time)
