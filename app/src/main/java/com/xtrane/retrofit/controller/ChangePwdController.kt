...
class ChangePwdController(var context: Activity, internal var controllerInterface: ControllerInterface) {
    private val TAG = "ChangePwdCont"
    var id = ""
    var token = ""
    fun callApi(oldPwd: String,newPwd: String) {
        ...
        val call: Call<ResponseBody?>? = RetrofitHelper.getAPI().changePasswordApi(id,token,oldPwd,newPwd)
