...
class CoachArchiveEventListController(var context: Activity, internal var view: ICoachEventListView):ICoachEventListController {
    ...
    override fun callCoachEventListApi(id: String, token: String, coach_id: String,type:String) {
        ...
        val call: Call<ResponseBody?>? = apiInterface.getArchiveCoachEventList(id,token,"1")
