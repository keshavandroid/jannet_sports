...
class PGetCoachListSportsTypeController(
    var context: Activity,
    internal var view: IParentBootomCoachesView
) : IPGetCoachListSportsTypeController {
    override fun callCOachListApi(id: String, token: String, sportsType: String) {
        val apiInterface: UserServices = APIClient.getClient()!!.create(UserServices::class.java)
        val call: Call<ResponseBody?>? = apiInterface.getCoachListSportsType(id, token, sportsType)
