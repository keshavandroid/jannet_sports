...
class TicketRegisterRequestController(var context: Activity, internal var view: IEventRegisterRequestView):IRegisterEventRequestController {
    override fun callEventRegisterRequestApi(id: String, token: String, status: String) {
        ...
        val call: Call<ResponseBody?>? = apiInterface.getAllTicketReq(id,token,status)
